				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Websettings">Web Settings</a>
							</li>
					...
					<div class="page-content">
							...
							<h3 class="header smaller lighter blue">Web Settings Table Edit</h3>
							<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Host Name : </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="host_name" placeholder="Category Name" value="<?php echo $record['host_name'];?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="admin_email" placeholder="Category Name" value="<?php echo $record['admin_email'];?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Admin Mobile : </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="admin_mobile" placeholder="Category Name" value="<?php echo $record['admin_mobile'];?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>	
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Admin Address : </label>

										<div class="col-sm-9">
											<textarea class="col-xs-10 col-sm-5" name="admin_address"><?php echo $record['admin_address'];?></textarea>
										</div>
									</div>									
