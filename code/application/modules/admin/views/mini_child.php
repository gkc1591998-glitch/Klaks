				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Category_child">Menu Items List</a>
							</li>
					...
					<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Menu Items List Table View</h3>
										<form method="post" action="<?php echo ADMIN_URL;?>Mini_child/delete_selected">
										<div class="clearfix">
											<div class="pull-left tableTools-container"></div>
											<div class="pull-right">
											<a  href="<?php echo ADMIN_URL; ?>Mini_child/add"  class="btn btn-primary">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $i;?></td>
														<td><?php echo stripslashes($row['category_name']); ?></td>
														<td><?php echo stripslashes($row['sub_category_name']); ?></td>
														<td><?php echo stripslashes($row['child_category_name']); ?></td>

														<td><?php echo stripslashes($row['mini_child_name']); ?></td>

														<td>
															<div class="hidden-sm hidden-xs action-buttons">

																<a class="green" href="<?php echo ADMIN_URL; ?>Category_child/edit/<?php echo $row['id'];?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="<?php echo ADMIN_URL; ?>Category_child/delete/<?php echo $row['id'];?>">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>Category_child/edit/<?php echo $row['id'];?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>Category_child/delete/<?php echo $row['id'];?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
