<div class="main-content">
	<div class="main-content-inner">
		<!-- #section:prices/content.breadcrumbs -->
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="<?php echo ADMIN_URL; ?>Prices">Prices</a>
				</li>
		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					<h3 class="header smaller lighter blue">Prices</h3>
					<!-- Add/Edit Price Form -->
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><?php echo isset($price) ? 'Edit Price' : 'Add Price'; ?></h4>
						</div>
						<div class="widget-body">
							<div class="widget-main">
								<?php if (isset($price)) {
									$action = site_url('admin/prices/edit/' . $price->id);
									$btn = 'Update';
								} else {
									$action = site_url('admin/prices/create');
									$btn = 'Add';
								} ?>
								<form method="post" action="<?= $action ?>" class="form-horizontal">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">Price Name</label>
										<div class="col-sm-9">
											<input type="text" name="name" class="col-xs-10 col-sm-8" placeholder="Price Name" value="<?= isset($price) ? $price->name : '' ?>" required />
										</div>
									</div>
									<?php if (isset($price)) { ?>
										<div class="form-group">
									...
									<div class="form-actions">
										<button type="submit" class="btn btn-success">
											<i class="ace-icon fa fa-check"></i> <?= $btn ?> Price
										</button>
									</div>
								</form>
							</div>
					...
					<form method="post" action="<?php echo ADMIN_URL; ?>prices/delete_selected">
						<div class="clearfix">
											...
											<tr>
												...
												<td>
													<div class="hidden-sm hidden-xs action-buttons">
														<a class="green" href="<?php echo ADMIN_URL; ?>prices/edit/<?php echo $row->id; ?>">
															<i class="ace-icon fa fa-pencil bigger-130"></i>
														</a>
														<a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>prices/delete/<?php echo $row->id; ?>';}">
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="<?php echo ADMIN_URL; ?>prices/edit/<?php echo $row->id; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="green">
																...
																<li>
																	<a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>prices/delete/<?php echo $row->id; ?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
																		<span class="red">
