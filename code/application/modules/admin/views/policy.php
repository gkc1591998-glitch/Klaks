			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue"> Policy Info</h3>
										<form method="post" action="<?php echo ADMIN_URL;?>Policy/delete_selected">
										<div class="clearfix">
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo ADMIN_URL; ?>Policy/edit/<?php echo $row['id'];?>">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>Policy/edit/<?php echo $row['id'];?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
