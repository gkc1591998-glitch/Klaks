							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="col-xs-10 col-sm-5"  required name="state_id" onchange="getcity(this.value);" >
												<option value="">Select State</option>
												<?php foreach($states as $values){ ?>
													<option <?php if($values['id']==$record['state_id']){ ?>  selected <?php } ?> value="<?php echo $values['id']; ?>"><?php echo stripslashes(str_replace("\n","",$values['state_name'])); ?></option>
												<?php } ?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select id="city_id" class="col-xs-10 col-sm-5"  required name="city_id" >
												<option value="">Select City</option>
												<?php foreach($cities as $values){ ?>
													<option <?php if($values['id']==$record['city_id']){ ?>  selected <?php } ?> value="<?php echo $values['id']; ?>"><?php echo stripslashes(str_replace("\n","",$values['city_name'])); ?></option>
												<?php } ?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  required name="Area_name" placeholder="Enter Area" value="<?php echo stripslashes($record['Area_name']); ?>"  class="col-xs-10 col-sm-5" />
										</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a class="btn" href="<?php echo ADMIN_URL;?>Area">
...
<![endif]-->
	...
	*/
	...
	$('#id-input-file-1 , #id-input-file-2').ace_file_input({
		...
		{
			$.ajax({ 
			   type: "POST", url: '<?php echo ADMIN_URL;?>Area/getcities', data: "valu="+valu,
