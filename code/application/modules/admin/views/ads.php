					...
					<div class="row">
								...
								<?php if($this->session->flashdata('msg_succ') != ''){ ?>
									...
									<div class="row">
										...
										<div class="col-sm-5">
										<div class="well">
											<h4 class="blue smaller lighter"><strong>Add New Advertisment</strong><font class="pull-right" size="2" color="red"><b>Width:337px, Height:400px</b></font></h4>
											<form method="post" enctype="multipart/form-data" action="<?php echo ADMIN_URL; ?>ads">
										 ...
										 <div class="col-xs-12">
										<form method="post" action="<?php echo ADMIN_URL;?>ads/ads_delete_selected">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $i;?></td>
														<td><img height="100" width="300" src="<?php echo site_url();?>images/ads/<?php echo stripslashes($row['image']); ?>"></td>
														<td><span <?php if($row['status']== 1){ echo " class='label label-success arrowed-in arrowed-in-right'"; } elseif($row['status']== 0){ echo "class='label label-danger arrowed'"; } ?>><a href="JavaScript:if(confirm('Are you sure want to Chanage the Status?')==true){window.location='<?php echo ADMIN_URL;?>ads/banner_status/<?php echo $row['id']?>/<?php echo $row['status'];?>';}" style="color:#FFF; text-decoration:none;"><?php if($row['status']== 1){ echo "Active"; } elseif($row['status']== 0){ echo "De-Active"; } ?></a></span></td>
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>ads/del_banner/<?php echo $row['id'];?>';}">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>ads/del_banner/<?php echo $row['id'];?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
