    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo ADMIN_URL; ?>Sizes">Sizes</a>
                </li>
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="header smaller lighter blue">Sizes</h3>
                    <!-- Add/Edit Size Form -->
                    <div class="widget-box">
                        <div class="widget-header">
                            <h4 class="widget-title"><?php echo isset($size) ? 'Edit Size' : 'Add Size'; ?></h4>
                        </div>
                        <div class="widget-body">
                            <div class="widget-main">
                                <?php if (isset($size)) { $action = site_url('admin/sizes/edit/'.$size->id); $btn = 'Update'; } else { $action = site_url('admin/sizes/create'); $btn = 'Add'; } ?>
                                <form method="post" action="<?= $action ?>" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right">Size Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="name" class="col-xs-10 col-sm-8" placeholder="Size Name" value="<?= isset($size) ? $size->name : '' ?>" required />
                                        </div>
                                    </div>
                                    <?php if (isset($size)) { ?>
                                    <div class="form-group">
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success">
                                            <i class="ace-icon fa fa-check"></i> <?= $btn ?> Size
                                        </button>
                                    </div>
                                </form>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="green" href="<?php echo ADMIN_URL; ?>sizes/edit/<?php echo $row->id;?>">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>
                                            <a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>sizes/delete/<?php echo $row->id;?>';}">
                                        ...
                                        <div class="hidden-md hidden-lg">
                                            <div class="inline pos-rel">
                                                ...
                                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                    <li>
                                                        <a href="<?php echo ADMIN_URL; ?>sizes/edit/<?php echo $row->id;?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                            <span class="green">
                                                    ...
                                                    <li>
                                                        <a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>sizes/delete/<?php echo $row->id;?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                            <span class="red">
