			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
							...
							<h3 class="header smaller lighter blue">Partners Table Add</h3>
							<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="url_link" placeholder="Url Link" value="<?php echo $record['linkk'];?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Alt Tag : </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="alt_tag" placeholder="Alt Tag" value="<?php echo $record['alt_tag'];?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>	
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<img src="<?php echo site_url();?>/images/partners/<?php echo $record['image'];?>" style="width:250px;height:200px;">
										</div>
									</div>
