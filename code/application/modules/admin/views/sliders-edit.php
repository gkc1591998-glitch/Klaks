					...
					<div class="page-content">
							...
							<div class="ace-settings-box clearfix" id="ace-settings-box">
								...
								<div class="pull-left width-50">
									<!-- #section:Sliders/sidebar.options -->
									<div class="ace-settings-item">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Slider tilte :</label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="name" placeholder="Slide Name" value="<?php echo stripcslashes(str_replace("\n","", $record['name'])); ?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-5">
											<img src="<?php echo site_url(); ?>images/sliders/<?php echo $record['image']; ?>" height="100" width="100">
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a class="btn" href="<?php echo ADMIN_URL;?>Sliders">
	...
	$('#id-input-file-1 , #id-input-file-2').ace_file_input({
		...
		<script>
			function getsubcat(id)
			{
				$.ajax({
				   type : "POST",   
				   url	: '<?php echo ADMIN_URL;?>Sliders/get_district',      
				   data	: "state_id="+id,
