				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Logo">Logo</a>
							</li>
					...
					<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Logo Table</h3>
										<form method="post" action="<?php echo ADMIN_URL;?>Logo/delete_selected">
										<div class="clearfix">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>1</td>
														<td align="center">
														<img src="<?php echo site_url();?>/images/logo/<?php echo $record['logo'];?>" height="100" width="100">
														</td>
												
														<td>
															<div class="hidden-sm hidden-xs action-buttons">

																<a class="green" href="<?php echo ADMIN_URL; ?>Logo/edit/<?php echo $record['id'];?>">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>Logo/edit/<?php echo $record['id'];?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
