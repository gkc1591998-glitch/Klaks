				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Partners">Partners</a>
							</li>
					...
					<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Partners Table</h3>
										<form method="post" action="<?php echo ADMIN_URL;?>Partners/delete_selected">
										<div class="clearfix">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $i;?></td>
														<td><?php echo stripslashes($row['linkk']); ?></td>
														<td><?php echo stripslashes($row['alt_tag']); ?></td>
														<td align="center">
														<img src="<?php echo site_url();?>/images/partners/<?php echo $row['image'];?>" style="width:150px;height:100px;">
														</td>
												
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="<?php echo ADMIN_URL; ?>Partners/view/<?php echo $row['id'];?>">
																	<i class="ace-icon fa fa-search-plus bigger-130"></i>
																</a>

																<a class="green" href="<?php echo ADMIN_URL; ?>Partners/edit/<?php echo $row['id'];?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="<?php echo ADMIN_URL; ?>Partners/delete/<?php echo $row['id'];?>">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>Partners/view/<?php echo $row['id'];?>" class="tooltip-info" data-rel="tooltip" title="View">
																				<span class="blue">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>Partners/edit/<?php echo $row['id'];?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>Partners/delete/<?php echo $row['id'];?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
