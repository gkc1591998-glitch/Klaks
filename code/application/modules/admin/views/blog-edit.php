								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-5">
											<img src="<?php echo site_url(); ?>images/blog/<?php echo $record['image']; ?>" height="100" width="100">
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a class="btn" href="<?php echo ADMIN_URL;?>Blog">
	...
	$('#id-input-file-1 , #id-input-file-2').ace_file_input({
		...
		<script>
			function getsubcat(id)
			{
				$.ajax({
				   type : "POST",   
				   url	: '<?php echo ADMIN_URL;?>Blog/get_district',      
				   data	: "state_id="+id,
