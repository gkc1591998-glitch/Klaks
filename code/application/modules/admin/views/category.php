<div class="main-content">
				<div class="main-content-inner">
					<!-- #section:categorys/content.breadcrumbs -->
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Category">Category View</a>
							</li>
							<li class="active">Main Page</li>
						</ul><!-- /.breadcrumb -->

						<!-- /section:categorys/content.searchbox -->
					</div>
					...
					<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Category View</h3>
										<form method="post" action="<?php echo ADMIN_URL;?>Category/delete_selected">
										<div class="clearfix">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $i;?></td>
														<td><?php echo stripcslashes(str_replace("\n","", $row['name'])); ?></td>

<!-- 											<td><img style="height:100px; width:100px;" src="<?php echo site_url();?>images/category/<?php echo stripslashes($row['image']); ?>"></td> -->


														<td><span <?php if($row['status']== 1){ echo " class='label label-success arrowed-in arrowed-in-right'"; } else if($row['status']== 0){ echo "class='label label-danger arrowed'"; } ?>><a href="JavaScript:if(confirm('Are you sure want to Chanage the Status?')==true){window.location='<?php echo ADMIN_URL;?>Category/status/<?php echo $row['id']?>/<?php echo $row['status'];?>';}" style="color:#FFF; text-decoration:none;"><?php if($row['status']== 1){ echo "Active"; } elseif($row['status']== 0){ echo "De-Active"; } ?></a></span>
														</td>
														
														
														<!-- <td><span <?php if($row['top_rated']== 1){ echo " class='label label-success arrowed-in arrowed-in-right'"; } else if($row['top_rated']== 0){ echo "class='label label-danger arrowed'"; } ?>><a href="JavaScript:if(confirm('Are you sure want to Chanage the Status?')==true){window.location='<?php echo ADMIN_URL;?>Category/top_category_status/<?php echo $row['id']?>/<?php echo $row['top_rated'];?>';}" style="color:#FFF; text-decoration:none;"><?php if($row['top_rated']== 1){ echo "Active"; } elseif($row['top_rated']== 0){ echo "De-Active"; } ?></a></span>
														</td> -->

														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="<?php echo ADMIN_URL; ?>Category/edit/<?php echo $row['id'];?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>Category/delete/<?php echo $row['id'];?>';}">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>Category/edit/<?php echo $row['id'];?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>Category/delete/<?php echo $row['id'];?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
							...
							<div class="ace-settings-box clearfix" id="ace-settings-box">
								...
								<div class="pull-left width-50">
									<!-- #section:categorys/sidebar.options -->
									<div class="ace-settings-item">
