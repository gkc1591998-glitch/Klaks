					...
					<div class="page-content">
							...
							<div class="ace-settings-box clearfix" id="ace-settings-box">
								...
								<div class="pull-left width-50">
									<!-- #section:bussiness_rules/sidebar.options -->
									<div class="ace-settings-item">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									...
									<?php /*<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="col-xs-10 col-sm-5"  required name="cat_id" onchange="getsubcat(this.value)">
												<option value="">--Select State--</option>
												<?php foreach($states as $value){ ?>
													<option value="<?php echo $value['id']; ?>" <?php if($value['id'] == $record['cat_id']){?> selected <?php } ?>><?php echo stripslashes(str_replace("\n","",$value['name'])); ?>
													</option>
												<?php } ?>
											</select>
										</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Select District : </label>

										<div class="col-sm-9">
											<select class="col-xs-10 col-sm-5"  required name="subcat_id" id="subcat_id">
												<option value="">--Select District--</option>
												<?php foreach($districts as $key => $value){?>
													<option value="<?php echo $value['id'];?>"<?php if($value['id'] == $record['subcat_id']){?> selected <?php } ?>><?php echo $value['name'];?></option>
												<?php } ?>
											</select>
										</div>
									</div>*/?>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tilte :</label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="name" placeholder="Enter Name" value="<?php echo stripcslashes(str_replace("\n","", $record['name'])); ?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<!--<div class="form-group">
										<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">old Image :</label>
										<div class="col-xs-12 col-sm-5">
											<img src="<?php echo site_url(); ?>images/bussiness_rules/<?php echo $record['image']; ?>" height="100" width="100">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-5">
											<font color="red">Note : Width = 360px, Height = 220px; </font>	
										</div>
									</div>
									
									<div class="form-group">
										<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">upload Image :</label>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a class="btn" href="<?php echo ADMIN_URL;?>bussiness_rules">
	...
	$('#id-input-file-1 , #id-input-file-2').ace_file_input({
		...
		<script>
			function getsubcat(id)
			{
				$.ajax({
				   type : "POST",   
				   url	: '<?php echo ADMIN_URL;?>bussiness_rules/get_district',      
				   data	: "state_id="+id,
