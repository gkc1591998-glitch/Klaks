				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL;?>Shippingandvat">Shipping charges</a>
							</li>
...
<?php echo $msg?$msg:'';?>
								<form class="form-horizontal" role="form" action="<?php echo ADMIN_URL;?>Shippingandvat/edit/<?php echo $record['id']?>" method="post" id="attributes-groups-form">
                                 <div style="background-color: #F5F5F5;border-radius: 6px 6px 6px 6px;padding: 8px; margin-bottom:20px;">
 
									<?php /*<div class="form-group">
										<div class="col-sm-3"> Shipping Charges ($) </div>
                                        <div class="col-sm-1"> : </div>

										<div class="col-sm-8">
											<input type="number" id="form-field-1"  class="col-xs-10 col-sm-12" name="shipping" value="<?php echo stripslashes($record['shipping']); ?>" required  />
										</div>
									</div>

									<div class="form-group">
										<div class="col-sm-3"> Vat  In (%) </div>
                                        <div class="col-sm-1"> : </div>

										<div class="col-sm-8">
											<input type="number" id="form-field-1"  class="col-xs-10 col-sm-12" name="vat" value="<?php echo stripslashes($record['vat']); ?>" required  />
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-3"> Dollar Value In Rupees: </div>
                                        <div class="col-sm-1"> : </div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
												<input type="submit" name="add" id="add" class="btn btn-sm btn-primary" value="Save" />
											&nbsp; &nbsp; &nbsp;
											<a href="<?php echo ADMIN_URL;?>Shippingandvat/" class="btn btn-sm btn-primary">
												Cancel
											</a>
										</div>
									</div>
