...
<div class="page-content">
	...
	<div class="ace-settings-box clearfix" id="ace-settings-box">
		...
		<div class="pull-left width-50">
			<!-- #section:Testimonials/sidebar.options -->
			<div class="ace-settings-item">
		...
		<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Name : </label>
					<div class="col-sm-9">
					<input type="text" id="form-field-1"  required name="name" placeholder="Enter  name" value="<?php echo stripslashes($record['name']); ?>"  class="col-xs-10 col-sm-5" />
				</div>
				</div>
				...
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Designation : </label>
					<div class="col-sm-9">
					<input type="text" id="form-field-1" name="designation" placeholder="Enter  Designation" value="<?php echo stripslashes($record['name']); ?>"  class="col-xs-10 col-sm-5" />
				</div>
				</div>
				...
				<div class="form-group">
						...
						<div class="col-xs-12 col-sm-5">
							<img src="<?php echo site_url(); ?>images/testimonials/<?php echo $record['image']; ?>" height="220" width="360">
						</div>
					</div>
			...
			<div class="clearfix form-actions">
				<div class="col-md-offset-3 col-md-9">
					...
					&nbsp; &nbsp; &nbsp;
					<a class="btn" href="<?php echo ADMIN_URL;?>Testimonials">
