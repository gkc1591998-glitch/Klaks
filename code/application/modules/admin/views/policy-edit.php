			<div class="main-content">
				<div class="main-content-inner">
					<!-- #section:Policys/content.breadcrumbs -->
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Policy"> Policy Info</a>
							</li>
							<li class="active">Add Page</li>
						</ul><!-- /.breadcrumb -->
					
						<!-- /section:Policys/content.searchbox -->
					</div>
					...
					<div class="page-content">
							...
							<div class="ace-settings-box clearfix" id="ace-settings-box">
								...
								<div class="pull-left width-50">
									<!-- #section:Policys/sidebar.options -->
									<div class="ace-settings-item">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">  Policy Info : </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1"  required name="name" placeholder="Enter Policy Info" value="<?php echo stripslashes($record['name']); ?>"  class="col-xs-10 col-sm-5" />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<textarea name="content"><?php echo stripslashes($record['content']); ?></textarea>
											<script>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a class="btn" href="<?php echo ADMIN_URL;?>Policy">
