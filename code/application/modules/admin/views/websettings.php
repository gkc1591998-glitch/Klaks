			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Web Settings Table</h3>
										<form method="post" action="<?php echo ADMIN_URL;?>Websettings/delete_selected">
										<div class="clearfix">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														<td class="center">
															<label class="pos-rel">
																<input type="checkbox" name="selected_ids[]" id="selected_ids[]" value="<?php echo $record['id'];?>" class="ace" />
																<span class="lbl"></span>
															</label>
														</td>
														<td>1</td>
														<td><?php echo stripslashes($record['host_name']); ?></td>
														<td><?php echo stripslashes($record['admin_email']); ?></td>
														<td><?php echo stripslashes($record['admin_mobile']); ?></td>
														<td><?php echo stripslashes($record['admin_address']); ?></td>
												
														<td>
															<div class="hidden-sm hidden-xs action-buttons">

																<a class="green" href="<?php echo ADMIN_URL; ?>Websettings/edit/<?php echo $record['id'];?>">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>Websettings/edit/<?php echo $record['id'];?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
