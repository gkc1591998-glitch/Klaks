<div class="main-content">
  <div class="main-content-inner">
    <!-- #section:coupons/content.breadcrumbs -->
    ...
    <div class="page-content">
      <div class="row">
        <div class="col-xs-12">
          <h3 class="header smaller lighter blue">Coupons</h3>
          <!-- Add/Edit Coupon Form -->
          <div class="widget-box">
            <div class="widget-header">
              <h4 class="widget-title"><?php echo isset($coupon) ? 'Edit Coupon' : 'Add Coupon'; ?></h4>
            </div>
            <div class="widget-body">
              <div class="widget-main">
                <?php if (isset($coupon)) {
                  $action = site_url('admin/coupons/edit/' . $coupon->id);
                  $btn = 'Update';
                } else {
                  $action = site_url('admin/coupons/create');
                  $btn = 'Add';
                } ?>
                <form method="post" action="<?= $action ?>" class="form-horizontal">
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">Coupon Code</label>
                    <div class="col-sm-9">
                      <input type="text" name="code" class="col-xs-10 col-sm-8" placeholder="Coupon Code" value="<?= isset($coupon) ? $coupon->code : '' ?>" required />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">Discount (%)</label>
                    <div class="col-sm-9">
                      <input type="number" name="discount" class="col-xs-10 col-sm-8" placeholder="Discount" value="<?= isset($coupon) ? $coupon->discount : '' ?>" required min="0" max="100" />
                    </div>
                  </div>
                  <?php if (isset($coupon)) { ?>
                    <div class="form-group">
                  ...
                  <div class="form-actions">
                    <button type="submit" class="btn btn-success">
                      <i class="ace-icon fa fa-check"></i> <?= $btn ?> Coupon
                    </button>
                  </div>
                </form>
              </div>
          ...
          <form method="post" action="<?php echo ADMIN_URL; ?>coupons/delete_selected">
            <div class="clearfix">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="hidden-sm hidden-xs action-buttons">
                            <a class="green" href="<?php echo ADMIN_URL; ?>coupons/edit/<?php echo $row->id; ?>">
                              <i class="ace-icon fa fa-pencil bigger-130"></i>
                            </a>
                            <a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>coupons/delete/<?php echo $row->id; ?>';}">
                          ...
                          <div class="hidden-md hidden-lg">
                            <div class="inline pos-rel">
                              ...
                              <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                <li>
                                  <a href="<?php echo ADMIN_URL; ?>coupons/edit/<?php echo $row->id; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                    <span class="green">
                                ...
                                <li>
                                  <a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>coupons/delete/<?php echo $row->id; ?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                    <span class="red">
