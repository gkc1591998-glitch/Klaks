			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<!-- /section:Testimonials/content.searchbox -->
					</div>

					<!-- /section:Testimonials/content.breadcrumbs -->
					...
					<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Testimonials</h3>
										<form method="post" action="<?php echo ADMIN_URL;?>Testimonials/delete_selected">
										<div class="clearfix">
											<div class="pull-left tableTools-container"></div>
											<div class="pull-right">
											<a  href="<?php echo ADMIN_URL; ?>Testimonials/add"  class="btn btn-primary">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
												        ...
												        <td><img style="height:100px; width:200px;" src="<?php echo site_url();?>images/testimonials/<?php echo stripslashes($row['image']); ?>"></td>
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																
																<a class="green" href="<?php echo ADMIN_URL; ?>Testimonials/edit/<?php echo $row['id'];?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>Testimonials/delete/<?php echo $row['id'];?>';}">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>Testimonials/edit/<?php echo $row['id'];?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>Testimonials/delete/<?php echo $row['id'];?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
