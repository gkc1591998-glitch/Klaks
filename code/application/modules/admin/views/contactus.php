			<div class="main-content">
				<div class="main-content-inner">
					<!-- #section:Contactuss/content.breadcrumbs -->
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Contactus">Contacted</a>
							</li>
							<li class="active">Main Page</li>
						</ul><!-- /.breadcrumb -->
					
						<!-- /section:Contactuss/content.searchbox -->
					</div>
					...
					<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Contacted</h3>
										<form method="post" action="<?php echo ADMIN_URL;?>Contactus/delete_selected">
										<div class="clearfix">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo stripslashes($row['msg']); ?></td>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>Contactus/delete/<?php echo $row['id'];?>';}">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>Contactus/delete/<?php echo $row['id'];?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
							...
							<div class="ace-settings-box clearfix" id="ace-settings-box">
								...
								<div class="pull-left width-50">
									<!-- #section:Contactuss/sidebar.options -->
									<div class="ace-settings-item">
