			<div class="main-content">
				<div class="main-content-inner">
					<!-- #section:bannerss/content.breadcrumbs -->
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<!-- /section:bannerss/content.searchbox -->
					</div>
					...
					<div class="row">
									<div class="col-xs-12">
										...
										<form method="post" action="<?php echo ADMIN_URL;?>Orders/multi_delete/">
											<div class="clearfix">
													<div class="pull-left tableTools-container"></div>
													<div class="pull-right">
												<!--	<a  href="<?php echo ADMIN_URL; ?>Orders/add"  class="btn btn-primary">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<?php if($row['viewstatus']==1){?>
														<td><?php echo $i; ?></td>
														<td><?php echo stripslashes($row['order_id']);?></td>
														...
														{ ?>
															<span class="badge badge-grey">DELIVERED</span>
													    <?php }
														else if($row['status']==0)
														{ ?>
															<span class="badge badge-important">WAITING</span>
														<?php }
														?></td>
														<?php } else if($row['viewstatus']==0){ ?>
														<td><b><?php echo $i; ?></b></td>
														<td><b><?php echo stripslashes($row['order_id']);?></b></td>
														<td><b><?php echo date('d-M-Y h:i A',strtotime($row['create_date_time']));?></b></td>
														<td><b><?php 
														if($row['status']==1)
														{  ?>
															<span class="badge badge-success">CONFIRMED</span>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="blue" href="<?php echo ADMIN_URL;?>Orders/orderdetailed/<?php echo $row['id'];?>">
																	<i class="ace-icon fa fa-search-plus bigger-130"></i>
																</a>
																
																<a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL;?>Orders/delete/<?php echo $row['id'];?>';}" >
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		<li>
																			<a href="<?php echo ADMIN_URL;?>Orders/orderdetailed/<?php echo $row['id'];?>" class="tooltip-info" data-rel="tooltip" title="View">
																				<span class="blue">
																		...
																		<li>
																			<a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL;?>Orders/delete/<?php echo $row['id'];?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
							...
							<div class="ace-settings-box clearfix" id="ace-settings-box">
								...
								<div class="pull-left width-50">
									<!-- #section:bannerss/sidebar.options -->
									<div class="ace-settings-item">
