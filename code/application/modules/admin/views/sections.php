<div class="main-content">
    <div class="main-content-inner">
        <!-- #section:sections/content.breadcrumbs -->
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo ADMIN_URL; ?>Sections">Sections</a>
                </li>
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="header smaller lighter blue">Sections</h3>
                    <!-- Add/Edit Section Form -->
                    <div class="widget-box">
                        <div class="widget-header">
                            <h4 class="widget-title"><?php echo isset($section) ? 'Edit Section' : 'Add Section'; ?></h4>
                        </div>
                        <div class="widget-body">
                            <div class="widget-main">
                                <?php if (isset($section)) { $action = site_url('admin/sections/edit/'.$section->id); $btn = 'Update'; } else { $action = site_url('admin/sections/create'); $btn = 'Add'; } ?>
                                <form method="post" action="<?= $action ?>" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right">Section Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="name" class="col-xs-10 col-sm-8" placeholder="Section Name" value="<?= isset($section) ? $section->name : '' ?>" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success">
                                            <i class="ace-icon fa fa-check"></i> <?= $btn ?> Section
                                        </button>
                                    </div>
                                </form>
                            </div>
                    ...
                    <form method="post" action="<?php echo ADMIN_URL;?>sections/delete_selected">
                    <div class="clearfix">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="green" href="<?php echo ADMIN_URL; ?>sections/edit/<?php echo $row->id;?>">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>
                                            <a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>sections/delete/<?php echo $row->id;?>';}">
                                        ...
                                        <div class="hidden-md hidden-lg">
                                            <div class="inline pos-rel">
                                                ...
                                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                    <li>
                                                        <a href="<?php echo ADMIN_URL; ?>sections/edit/<?php echo $row->id;?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                            <span class="green">
                                                    ...
                                                    <li>
                                                        <a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>sections/delete/<?php echo $row->id;?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                            <span class="red">
