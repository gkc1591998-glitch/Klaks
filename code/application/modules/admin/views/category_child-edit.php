				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Category_child">Child Main Category</a>
							</li>
					...
					<div class="page-content">
							...
							<h3 class="header smaller lighter blue">Child Category Edit</h3>
							<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<h3 class="header smaller lighter blue">Child Category View</h3>
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Main Category : </label>

										<div class="col-sm-9">
											<select name="category_name" onchange="getsubcat(this.value)" class="col-xs-10 col-sm-5">
												<option value="">Select Main Category</option>
												<?php foreach($category as $key => $value){?>
													<option value="<?php echo $value['id'];?>"<?php if($value['id'] == $record['category_id']){?> selected <?php } ?>><?php echo $value['name'];?></option>
												<?php } ?>
											</select>
										</div>
									</div>	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select   name="sub_category_name" id="sub_category_name" class="col-xs-10 col-sm-5">
												<option value="">Select Sub Category</option>
												<?php foreach($subcategory as $key => $value){?>
													<option value="<?php echo $value['id'];?>"<?php if($value['id'] == $record['sub_category_id']){?> selected <?php } ?>><?php echo $value['name'];?></option>
												<?php } ?>
											</select>
										</div>
									</div>	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="child_category_name" value="<?php echo $record['child_category_name'];?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
...
function getsubcat(id){
			$.ajax({
			   type : "POST",   
			   url	: '<?php echo ADMIN_URL;?>category_child/getsubcat',      
