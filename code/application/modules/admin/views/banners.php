					...
					<div class="row">
								...
								<?php if($this->session->flashdata('msg_succ') != ''){ ?>
									...
									<div class="row">
										...
										<?php /*<div class="well">
											<h4 class="blue smaller lighter"><strong>Add Image</strong><font class="pull-right" size="2" color="red"><b>Width:1000px, Height:400px</b></font></h4>
											<form method="post" enctype="multipart/form-data" action="<?php echo ADMIN_URL; ?>banners">
											<span class="col-xs-6 col-sm-10">
												<input type="file" name="image" id="id-input-file-2" required />
											</span>


											<button class="btn btn-xs btn-primary"  type="submit"  value="submit" name="submit" >Add</button>
										   </form>
										</div> */?>

										<div class="well">
											<h4 class="blue smaller lighter"><strong>Add Banner text</strong></h4>
											<form method="post" enctype="multipart/form-data" action="<?php echo ADMIN_URL; ?>banners">
												<div class="form-group row">
													<label for="discount" class="col-sm-2 col-form-label">Text</label>
													<div class="col-sm-10">
										 ...
										 <div class="col-xs-12">
										<form method="post" action="<?php echo ADMIN_URL;?>banners/banners_delete_selected">
										<div class="pull-right">
											<button title="Delete All" class="btn btn-xs btn-danger" type="submit" onClick="return delete_selected_fields();" name="submit" value="submit">
												<i class="ace-icon fa  fa-trash-o fa-lg"> Delete All</i>
											</button>
											</div>
										<script type="text/javascript">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<?php /*<td><img height="100" width="300" src="<?php echo site_url();?>images/banners/<?php echo stripslashes($row['image']); ?>"></td> */?>
														<td><span <?php if($row['status']== 1){ echo " class='label label-success arrowed-in arrowed-in-right'"; } elseif($row['status']== 0){ echo "class='label label-danger arrowed'"; } ?>><a href="JavaScript:if(confirm('Are you sure want to Chanage the Status?')==true){window.location='<?php echo ADMIN_URL;?>banners/banner_status/<?php echo $row['id']?>/<?php echo $row['status'];?>';}" style="color:#FFF; text-decoration:none;"><?php if($row['status']== 1){ echo "Active"; } elseif($row['status']== 0){ echo "De-Active"; } ?></a></span></td>
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>banners/del_banner/<?php echo $row['id'];?>';}">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>banners/del_banner/<?php echo $row['id'];?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
