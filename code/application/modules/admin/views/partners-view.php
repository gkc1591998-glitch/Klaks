			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
							...
							<h3 class="header smaller lighter blue">Partners Table View</h3>
							<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<a href="<?php echo ADMIN_URL; ?>Partners/edit/<?php echo $record['id'];?>" class="btn btn-info">
