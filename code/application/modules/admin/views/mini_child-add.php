				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>category_child">Child Category</a>
							</li>
					...
					<div class="page-content">
							...
							<h3 class="header smaller lighter blue">Child Category Table Add</h3>
							<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Menu Category Name : </label>

										<div class="col-sm-9">
											<select id="form-field-1"  name="category_name" onchange="getsubcat(this.value)" class="col-xs-10 col-sm-5">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Sub Menu List Name : </label>

										<div class="col-sm-9">
											<select  name="sub_category_name" id="sub_category_name" onchange="getchild(this.value)" class="col-xs-10 col-sm-5">
												<option value="">select Sub Menu List</option>
											</select>
										</div>
									</div>	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select name="mini_child_name" id="mini_child_name" class="col-xs-10 col-sm-5">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Child Category Name : </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="child_category_name" placeholder="Child Category Name" value="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
...
<![endif]-->
        ...
        <script>
	        function getsubcat(id){
				$.ajax({
				   type : "POST",   
				   url	: '<?php echo ADMIN_URL;?>Mini_child/getsubcat',      
				   data	: "category_name="+id,
				   complete: function(data){  
					  var op = data.responseText.trim();
					 //alert(op);
					 $("#sub_category_name").html(op);  
				   }
				});
			}
        </script>
        ...
        <script>
            function getchild(id){
				$.ajax({
				   type : "POST",   
				   url	: '<?php echo ADMIN_URL;?>Mini_child/get_child_cat',      
				   data	: "sub_category_name="+id,
				   complete: function(data){  
					  var op = data.responseText.trim();
					 //alert(op);
					 $("#mini_child_name").html(op);  
				   }
				});
			}
		</script>
