			<div class="main-content">
				<div class="main-content-inner">
					<!-- #section:Subcategorys/content.breadcrumbs -->
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Subcategory">Sub Category</a>
							</li>
							<li class="active">Main Page</li>
						</ul><!-- /.breadcrumb -->
						<!-- /section:Subcategorys/content.searchbox -->
					</div>
					...
					<div class="page-content">
					    ...
					    <div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Sub Category View</h3>
										<form method="post" action="<?php echo ADMIN_URL;?>Subcategory/delete_selected">
										<div class="clearfix">
											<div class="pull-left tableTools-container"></div>
											<div class="pull-right">
											<a  href="<?php echo ADMIN_URL; ?>Subcategory/add"  class="btn btn-primary">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>Subcategory/edit/<?php echo $row['id'];?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>Subcategory/delete/<?php echo $row['id'];?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
							...
							<div class="ace-settings-box clearfix" id="ace-settings-box">
								...
								<div class="pull-left width-50">
									<!-- #section:Subcategorys/sidebar.options -->
									<div class="ace-settings-item">
