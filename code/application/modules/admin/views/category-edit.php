				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Category">Category</a>
							</li>
					...
					<div class="page-content">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<h3 class="header smaller lighter blue">Edit Category</h3>
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">  Category: </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="name" placeholder="Enter Category" value="<?php echo stripslashes($record['name']); ?>"  class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-5">
											<img src="<?php echo site_url(); ?>images/category/<?php echo $record['image']; ?>" height="150" width="150">
										</div>
								    </div>
									<div class="form-group">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a class="btn" href="<?php echo ADMIN_URL;?>category">
