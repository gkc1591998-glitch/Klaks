					...
					<div class="page-content">
						...
						<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
								...
								<div class="col-sm-9">
									<select id="cat_id" class="col-xs-10 col-sm-5" name="cat_id" onchange="getcity(this.value)">
										...
										<?php foreach($maincat as $values){ ?>
											<option value="<?php echo $values['id']; ?>"><?php echo stripslashes(str_replace("\n","",$values['name'])); ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" autocomplete="on" name="title"  class="col-xs-10 col-sm-5"  placeholder="---Enter Titlee---"/>
								</div>
							</div>
							...
							<!-- <div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" autocomplete="on" name="xsprice"  class="col-xs-10 col-sm-5"  placeholder="---Enter XS size price---"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" autocomplete="on" name="sprice"  class="col-xs-10 col-sm-5"  placeholder="---Enter S size price---"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" autocomplete="on" name="mprice"  class="col-xs-10 col-sm-5"  placeholder="---Enter M size price---"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" autocomplete="on" name="lprice"  class="col-xs-10 col-sm-5"  placeholder="---Enter L size price---"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" autocomplete="on" name="xlprice"  class="col-xs-10 col-sm-5"  placeholder="---Enter XL size price---"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" autocomplete="on" name="xxlprice"  class="col-xs-10 col-sm-5"  placeholder="---Enter XXL size price---"/>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1" autocomplete="on" name="priceRange"  class="col-xs-10 col-sm-5"  placeholder="---Enter Price range---"/>
							</div>
						</div> -->
							...
							<!-- <div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" autocomplete="on" name="price"  class="col-xs-10 col-sm-5" onkeypress="return isNumber(event)"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" autocomplete="on" name="dprice"  class="col-xs-10 col-sm-5" onkeypress="return isNumber(event)"/>
								</div>
							</div> -->
							...
							<!-- Grouped dropdowns in one row with add button -->
							<!-- <div class="form-group">
...
<script>
	// Use event delegation and clone the HTML, not the jQuery object
