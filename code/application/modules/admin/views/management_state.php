			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">State Table</h3>
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" href="<?php echo ADMIN_URL; ?>State/delete/<?php echo $row['id'];?>">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>State/delete/<?php echo $row['id'];?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
