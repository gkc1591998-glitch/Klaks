				...
				<div class="main-content-inner">
					...
					<div class="row">
									<div class="col-xs-12">
										...
										<form method="post" action="<?php echo ADMIN_URL;?>Payments/delete_selected">
											<div class="clearfix">
													<div class="pull-left tableTools-container"></div>
													<div class="pull-right">
												<!--	<a  href="<?php echo ADMIN_URL; ?>Payments/add"  class="btn btn-primary">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $i; ?></td>
														<td><?php echo !empty($row['order_id']) ? stripslashes($row['order_id']) : 'Student ID: ' . $row['student_id']; ?></td>
														<td><?php echo stripslashes($row['razorpay_payment_id'] ? $row['razorpay_payment_id'] : 'Pending'); ?></td>
														...
														<td><?php echo $row['paid_at'] ? date('d-m-Y H:i', strtotime($row['paid_at'])) : 'N/A'; ?></td>
														
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																
																<a class="blue" href="<?php echo ADMIN_URL;?>Payments/payments_detailed/<?php echo $row['id'];?>">
																	<i class="ace-icon fa fa-search-plus bigger-130"></i>
																</a>
																
																<a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL;?>Payments/delete/<?php echo $row['id'];?>';}" >
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		<li>
																			<a href="<?php echo ADMIN_URL;?>Payments/payments_detailed/<?php echo $row['id'];?>" class="tooltip-info" data-rel="tooltip" title="View">
																				<span class="blue">
																		...
																		<li>
																			<a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL;?>Payments/delete/<?php echo $row['id'];?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
