					...
					<div class="breadcrumbs" id="breadcrumbs">
						<script type="text/javascript">
						 ...
						 <ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Subcategory">Sub Category List</a>
							</li>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="col-xs-10 col-sm-5"  required name="cat_id" >
												<option value="">Select Category</option>
												<?php foreach($categories as $values){ ?>
													<option <?php if($values['id']==$record['cat_id']){ ?>  selected <?php } ?> value="<?php echo $values['id']; ?>"><?php echo stripslashes(str_replace("\n","",$values['name'])); ?></option>
												<?php } ?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  required name="name" placeholder="Enter Sub Category" value="<?php echo stripslashes($record['name']); ?>"  class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-5">
											<img src="<?php echo site_url(); ?>images/districts/<?php echo $record['image']; ?>" height="220" width="360">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<textarea name="content"><?php echo stripslashes(str_replace("\n","",$record['content'])); ?></textarea>
											<script>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a class="btn" href="<?php echo ADMIN_URL;?>Subcategory">
