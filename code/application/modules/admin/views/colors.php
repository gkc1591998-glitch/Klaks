<div class="main-content">
				<div class="main-content-inner">
					<!-- #section:colors/content.breadcrumbs -->
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Colors">Colors</a>
							</li>
							<li class="active">Main Page</li>
						</ul><!-- /.breadcrumb -->

						<!-- /section:colors/content.searchbox -->
					</div>
					...
					<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Colors</h3>
										<!-- Add/Edit Color Form -->
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="widget-title"><?php echo isset($color) ? 'Edit Color' : 'Add Color'; ?></h4>
											</div>
											<div class="widget-body">
												<div class="widget-main">
													<?php if (isset($color)) { $action = site_url('admin/colors/edit/'.$color->id); $btn = 'Update'; } else { $action = site_url('admin/colors/create'); $btn = 'Add'; } ?>
													<form method="post" action="<?= $action ?>" class="form-horizontal">
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right">Color Name</label>
															<div class="col-sm-9">
																<input type="text" name="name" class="col-xs-10 col-sm-8" placeholder="Color Name" value="<?= isset($color) ? $color->name : '' ?>" required />
															</div>
														</div>
														<?php if (isset($color)) { ?>
														<div class="form-group">
															...
															<div class="col-sm-9">
																<select name="status" class="col-xs-10 col-sm-8">
														...
														<div class="form-actions">
															<button type="submit" class="btn btn-success">
																<i class="ace-icon fa fa-check"></i> <?= $btn ?> Color
															</button>
														</div>
													</form>
												</div>
										...
										<form method="post" action="<?php echo ADMIN_URL;?>colors/delete_selected">
										<div class="clearfix">
											<div class="pull-left tableTools-container"></div>
											<div class="pull-right">
												<!-- <a  href="<?php echo ADMIN_URL; ?>colors/create"  class="btn btn-primary">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														<td class="center">
															<label class="pos-rel">
																<input type="checkbox" name="selected_ids[]" value="<?php echo $row->id;?>" class="ace" />
																<span class="lbl"></span>
															</label>
														</td>
														<td><?php echo $i;?></td>
														<td><?php echo stripcslashes($row->name); ?></td>
														<td><span class="label label-<?php echo $row->status==1?'success':'danger'; ?> arrowed-in arrowed-in-right"><?php echo $row->status==1?'Active':'Inactive'; ?></span></td>
														<td><?php echo $row->created_date_time; ?></td>
														<td><?php echo $row->updated_date_time; ?></td>
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="<?php echo ADMIN_URL; ?>colors/edit/<?php echo $row->id;?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>colors/delete/<?php echo $row->id;?>';}">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo ADMIN_URL; ?>colors/edit/<?php echo $row->id;?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>colors/delete/<?php echo $row->id;?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
