...
class Discount extends CI_Controller {
	...
	public $addPage    = 'discount-add';	   
	public $editPage   = 'discount-edit';   
	public $listPage   = 'discount';		  

	public $listPage_redirect = '/admin/Discount';		 
	public $addPage_redirect  = '/admin/Discount/add/';	
	public $editPage_redirect = '/admin/Discount/edit/';  


	public function __construct() {
        parent::__construct();
  		$this->load->model('Discount_model','my_model');  
