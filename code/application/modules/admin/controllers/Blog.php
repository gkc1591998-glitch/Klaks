...
class Blog extends CI_Controller 
 {
	...
	public $addPage    = 'blog-add';
	public $editPage   = 'blog-edit';
	public $listPage   = 'blog';

	public $listPage_redirect = '/admin/Blog';
	public $addPage_redirect  = '/admin/Blog/add/';
	public $editPage_redirect = '/admin/Blog/edit/';
	...
	public function add()
	{
		...
		if($this->input->post('submit') != '')
		{
			$exit_data = array
			(
				'title' => mysqli_real_escape_string(ucwords($this->get_mysqli(),$this->input->post('title')))
			);
