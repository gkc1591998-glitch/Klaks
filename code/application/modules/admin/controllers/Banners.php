...
class Banners extends CI_Controller {
	...
	{
        parent::__construct();
		$this->load->model('Banners_model','my_model'); 	
	...
	{	
		if($this->input->post('submit')!='')
		{
				/*  if ($_FILES['image']['name'] != '') 
				  {
						...
						else
						{
							...
							$config_image = array(
								  'image_library' => 'gd2',
								  'source_image' => './images/banners/'.$data['file_name'],
								 'new_image' => './images/banners/'.$data['file_name'],
									'width' => 1000,
									'height' => 400,
				...
				else
				{
					...
					$result = $this->my_model->add_banner();
					if($result)
					{
        ...
        {
			$data['record'] = $this->my_model->get_banners();
		...
		public function banners_delete_selected()
		{
