...
class Brands extends CI_Controller {
	...
	public $addPage  = 'brands-add';	   
	public $editPage = 'brands-edit';   
	public $listPage = 'brands';		  

	public $listPage_redirect = '/admin/Brands';		 
	public $addPage_redirect = '/admin/Brands/add/';	
	public $editPage_redirect = '/admin/Brands/edit/';  


	public function __construct() {
        parent::__construct();
  		$this->load->model('Brands_model','my_model');  
