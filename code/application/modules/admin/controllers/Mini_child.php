...
class Mini_child extends CI_Controller {
	
	public $headerPage = 'admin_header';
	public $listPage   = 'mini_child';
	public $addPage    = 'mini_child-add';
	public $editPage   = 'mini_child-edit';
	public $viewPage   = 'mini_child-view';
	public $listPage_redirect = 'admin/Mini_child';
	
	public function __construct() 
	{
        parent::__construct();
		$this->load->model('Mini_child_model','my_model'); 	
	...
	public function get_child_cat(){
		...
		$getData = $this->my_model->getchildcat($sub_cat_id);  
		$selBox = '<option value="" >-- Select Menu Item Category --</option>';
		foreach($getData as $rows){
			$selBox .= '<option value="'. $rows['id'].'" >'.$rows['child_category_name'].'</option>';
		}
		echo $selBox;
	}	
