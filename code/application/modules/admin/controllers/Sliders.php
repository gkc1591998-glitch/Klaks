...
class Sliders extends CI_Controller 
 {
	...
	public $addPage  = 'sliders-add';
	public $editPage = 'sliders-edit';
	public $listPage = 'sliders';

	public $listPage_redirect = '/admin/Sliders';
	public $addPage_redirect  = '/admin/Sliders/add/';
	public $editPage_redirect = '/admin/Sliders/edit/';


	public function __construct() {
        parent::__construct();
  		$this->load->model('Sliders_model','my_model');
		...
		if($this->input->post('submit') != '')
		{
			...
			if($exit_details == 0)
			{
				if ($_FILES['image']['name'] != '') {
					$config['upload_path'] = './images/sliders'; /* NB! create this dir! */
	...
	public function edit($id)
	{
		...
		$this->load->view($this->headerPage);
		$data['states']= $this->my_model->get_states();
		$data['districts'] = $this->my_model->get_districts();
   ...
   public function get_district()
   {
		...
		$getData = $this->my_model->getAjaxDistrict($id);
