              ...
              <article id="post-29" class="blog_entry clearfix wow bounceInUp animated animated animated" style="visibility: visible;">
                <header class="blog_entry-header clearfix">
                  <div class="blog_entry-header-inner">
                    <h2 class="blog_entry-title"> <a href="blog-detail.html" rel="bookmark"><?php echo (stripslashes(str_replace('\n','',$value['title']))); ?></a> </h2>
                    <div class="entry-meta">
                      <time class="entry-date"><?php echo date("F jS, Y", strtotime($value['create_date_time']));?></time>
                      . </div>
                  </div>
                  <!--blog_entry-header-inner--> 
                </header>
                <div class="entry-content">
                  <div class="featured-thumb"><a href="#"><img src="<?php echo site_url();?>images/blog/<?php echo (stripslashes(str_replace('\n','',$value['image']))); ?>" alt="blog-img3"></a></div>
                  <div class="entry-content">
                    <p><?php echo (stripcslashes(str_replace('\n','',$value['content']))); ?></p>
                  </div>
                  <p> <a href="<?php echo site_url();?>blog/view/<?php echo (stripslashes(str_replace('\n','',$value['id']))); ?>" class="btn">Read More</a> </p>
                </div>
              </article>
              <?php } } ?>
