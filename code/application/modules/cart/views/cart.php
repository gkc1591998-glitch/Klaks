                    ...
                    <div class="akasha">
                                        ...
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                ...
                                                <td data-title="Subtotal"><span class="akasha-Price-amount amount">
                                                    <span
                                                        class="akasha-Price-currencySymbol">₹</span><?php echo number_format($this->cart->total(),2); ?>
                                                    </span><br/>
                        ...
                        <div class="col-md-12 col-sm-12 dreaming_crosssell-product">
                            ...
                            <div class="owl-slick owl-products equal-container better-height"
                                ...
                                <?php
                                    // Provide $products list for the partial and include it. The partial expects $products variable.
                                    $products = isset($cross_sell_products) ? $cross_sell_products : [];
