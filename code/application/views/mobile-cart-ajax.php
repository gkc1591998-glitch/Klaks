                    ...
                    <?php foreach ($this->cart->product_options($items['rowid']) as $option_name => $option_value): ?>
                      <?php if($option_name=='image'){ ?>
                        <li class="akasha-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button" onClick="deletecart('<?php echo $items['rowid']; ?>');">×</a>
                            <a href="#">
                              <img 
                                src="<?php echo site_url(); ?>images/products/<?php echo $option_value; ?>"
