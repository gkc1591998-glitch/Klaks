...
// $config['base_url'] = 'http://'.$_SERVER['SERVER_NAME'].'/main';
$config['base_url'] = 'https://instructoedtech.in/';
...
/*
|--------------------------------------------------------------------------
| Home module category slug overrides
|--------------------------------------------------------------------------
| These allow the Home_model to look up categories by slug without hardcoding
| literal values in the model. Override in environment-specific configs if
| needed.
*/
$config['home_slug_men'] = 'men';
$config['home_slug_women'] = 'women';
$config['home_slug_accessories'] = 'accessories';
